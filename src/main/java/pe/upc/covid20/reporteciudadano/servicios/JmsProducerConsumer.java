...
public class JmsProducerConsumer {
    ...
    public void enviarRecibir(String msg) {
        ...
        System.out.println("COVID20: Enviando " + msg);
        System.out.println("RICOVID20PLEY: Enviando con CorrId: " + id);
        ...
        String responseMessage = (String) jmsTemplate
                .receiveSelectedAndConvert(responseQueue,
                        "JMSCorrelationID='" + id + "'");
        System.out.println("COVID20 RESPUESTA:" + responseMessage);
        System.out.println("COVID20 RESPUESTA CORR ID:" + id);
    }
